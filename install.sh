...
echo "servers that do NOT read your ~/.tmux.conf. To add your own tmux settings"
echo "(vi copy-mode, bindings, status style, …), copy the overlay example:"
echo "  cp ~/.agentmux/config/user.tmux.conf.example ~/.agentmux/user.tmux.conf"
echo "It's sourced last (your settings win). See its header for the caveats."
echo ""
