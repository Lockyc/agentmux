...
echo ""
echo "Your ~/.tmux.conf needs no agentmux line. 'source-file ~/.agentmux/tmux/agentmux.conf'"
echo "there is only for running Claude in plain tmux outside amux, and it installs amux's"
echo "hooks and bindings on that regular server — drop it if you don't need that."
echo ""
